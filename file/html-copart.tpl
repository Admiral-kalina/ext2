<div class="p-0 lot-information d-flex f-g1" id="usca">
	<div class="p-0 panel f-g2 d-flex-column full-width">
		<div class="panel-heading page-titles" style="overflow: hidden !important; position: relative;">
			<h3>
				<strong>USCA просчет авто из США</strong>
			</h3>
		...
		<div class="tab-content f-g1 d-f">
			<div class="panel-content clearfix f-g1 d-flex-column full-width" ng-show="(activeTab === 1)">
				<div class="f-g2">
					<div class="clearfix">
						<div style="align-items: center;width: 100%;display: flex;justifyContent: space-between;">
							...
							<span id="vinDiv" class=" lot-details-desc right d-f align-center">
								<input style="max-width:120px; margin-left:auto" class="input-md form-control" type="text" name="lp" pattern="[0-9.]+" value="">
							</span>
						</div>
					</div>
				...
				<div style="text-align: center;">
                    ...
                    onclick="navigator.clipboard.writeText(jsl('.c1').a.innerText)"
                    ><a>Скопировать данные</a></button>
